...
public class OrderServiceImplTests {
    ...
    public void testPlaceOrder() {
        ...
        oi1.setProduct(newProduct("Nokia",Money.valueOf(Currency.MKD,1500)));
        oi1.setQuantity(1);

        OrderItemForm oi2 = new OrderItemForm();
        oi2.setProduct(newProduct("Samsung A51",Money.valueOf(Currency.MKD,5000)));
        oi2.setQuantity(2);
        ...
        Assertions.assertEquals(newOrder.total(),Money.valueOf(Currency.MKD,6500));
