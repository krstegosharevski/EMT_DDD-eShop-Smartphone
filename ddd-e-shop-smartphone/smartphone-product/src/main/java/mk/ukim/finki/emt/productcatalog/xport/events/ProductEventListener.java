...
public class ProductEventListener {
    ...
    public void consumeOrderItemCreatedEvent(String jsonMessage) {
        try {
            ...
            productService.orderItemCreated(SmartphoneId.of(event.getProductId()), event.getQuantity());
        } catch (Exception e){
    ...
    public void consumeOrderItemRemovedEvent(String jsonMessage) {
        try {
            ...
            productService.orderItemRemoved(SmartphoneId.of(event.getProductId()), event.getQuantity());
        } catch (Exception e){
